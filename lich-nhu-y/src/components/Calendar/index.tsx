      ...
      <div className="text-center col-span-5 p-6 max-md:p-0 rounded-l-[32px]  lg:border-[#6E7074] xl:border-r max-lg:ml-4">
        <div className="text-center w-full">
          <div className="flex flex-col px-2 justify-center max-lg:w-full">
            <div
              className={`text-[156px] ${colorLunarDay(
                lunarDayInfo.dayType
              )} font-extrabold leading-[156px]`}
            >
            ...
            <div
              className={`${colorDayType(
                lunarDayInfo.dayType
              )}  p-2 mx-auto rounded-3xl font-medium text-sm px-8`}
            >
              {(lunarDayInfo.dayType === "GOOD" ||
                lunarDayInfo.dayType === "BAD") &&
                handleDayType(lunarDayInfo.dayType)}
            </div>
            <Quote />
          </div>
          <div className="bg-[#F2F4F7] grid grid-cols-3 w-full justify-between py-6 rounded-3xl mt-[29px] max-md:gap-2 items-center max-m:w-full max-md:w-full">
            <div className="flex flex-col">
              <span className="text-xs text-[#111111]">Ngày</span>
              <span
                className={`text-[32px] font-bold leading-[48px] ${colorLunarDay(
                  lunarDayInfo.dayType
                )}`}
              >
